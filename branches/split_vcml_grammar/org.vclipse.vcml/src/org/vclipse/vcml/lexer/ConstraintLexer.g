...
@header {
package org.vclipse.vcml.lexer;
...
KEYWORD_73 : '$'('C'|'c')('O'|'o')('U'|'u')('N'|'n')('T'|'t')'_'('P'|'p')('A'|'a')('R'|'r')('T'|'t')('S'|'s');

KEYWORD_74 : ('R'|'r')('E'|'e')('S'|'s')('T'|'t')('R'|'r')('I'|'i')('C'|'c')('T'|'t')('I'|'i')('O'|'o')('N'|'n')('S'|'s');

KEYWORD_72 : ('R'|'r')('E'|'e')('S'|'s')('T'|'t')('R'|'r')('I'|'i')('C'|'c')('T'|'t')('I'|'i')('O'|'o')('N'|'n');

KEYWORD_69 : '$'('S'|'s')('U'|'u')('M'|'m')'_'('P'|'p')('A'|'a')('R'|'r')('T'|'t')('S'|'s');

KEYWORD_70 : ('I'|'i')('N'|'n')('F'|'f')('E'|'e')('R'|'r')('E'|'e')('N'|'n')('C'|'c')('E'|'e')('S'|'s');

KEYWORD_71 : ('S'|'s')('U'|'u')('B'|'b')('P'|'p')('A'|'a')('R'|'r')('T'|'t')'_'('O'|'o')('F'|'f');

KEYWORD_66 : ('C'|'c')('O'|'o')('N'|'n')('D'|'d')('I'|'i')('T'|'t')('I'|'i')('O'|'o')('N'|'n');

KEYWORD_67 : ('I'|'i')('S'|'s')'_'('O'|'o')('B'|'b')('J'|'j')('E'|'e')('C'|'c')('T'|'t');

KEYWORD_68 : ('S'|'s')('P'|'p')('E'|'e')('C'|'c')('I'|'i')('F'|'f')('I'|'i')('E'|'e')('D'|'d');
