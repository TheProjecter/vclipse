...
public class SelectionConditionDisplayActionHandler extends SelectionConditionReader implements IVcmlOutlineActionHandler<SelectionCondition>{
	...
	public void run(SelectionCondition selectionCondition, Resource resource, IProgressMonitor monitor, Set<String> seenObjects) throws JCoException {
		read(selectionCondition.getName(), resource, monitor, seenObjects, false);
	}
